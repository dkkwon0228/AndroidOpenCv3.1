package com.example.dannykwon.androidopencv31;
...
public class MainActivity extends AppCompatActivity
  ...
  // 수정 4. cpp에 추가할 jni함수를 위한 네이티브 메소드 선언을 추가합니다.
  ...
  public Mat onCameraFrame(CameraBridgeViewBase.CvCameraViewFrame inputFrame) {
    ...
    // 수정 6. 카메라로부터 영상을 가져올 때마다 jni 함수 detect를 호출하도록 합니다.
  ...
  // 수정 1. 외장 저장소에 파일 저장하기 위한 퍼미션을 추가합니다.
    ...
    switch(requestCode){
      ...
      case PERMISSIONS_REQUEST_CODE:
        if (grantResults.length > 0) {
          ...
          // 수정 2.  WRITE_EXTERNAL_STORAGE 퍼미션 확인을 위해 필요한 코드를 추가합니다.
