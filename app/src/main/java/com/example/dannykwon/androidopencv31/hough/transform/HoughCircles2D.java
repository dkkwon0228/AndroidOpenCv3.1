package com.example.dannykwon.androidopencv31.hough.transform;
        ...
        for (int x = 0; x < width - distance; x++) {
            for (int y = 0; y < height - distance; y++) {
                ...
                if (houghSpace[x][y] > threshold) {
                    ...
                    Imgproc.circle(image, center, radius, new Scalar(0, 255, 0), 3);

                    //Draw the center in red color
                    Imgproc.line(image, center, center, new Scalar(255, 0, 0), 3);
