...
extern "C" {
  ...
  Java_com_example_dannykwon_androidopencv31_MainActivity_loadCascade(JNIEnv *env, jclass type,
...
JNIEXPORT void JNICALL
  Java_com_example_dannykwon_androidopencv31_MainActivity_detect(JNIEnv *env, jclass type,
...
JNIEXPORT void JNICALL
  Java_com_example_dannykwon_androidopencv31_MainActivity_ConvertRGBtoGray(JNIEnv *env,
                                                                           jobject instance,
                                                                           jlong matAddrInput,
                                                                           jlong matAddrResult) {
...
/*
  ...
  Java_com_example_dannykwon_androidopencv31_MainActivity_stringFromJNI(
      JNIEnv* env,
      jobject ) {
...
/*
JNIEXPORT void JNICALL
  Java_com_example_dannykwon_androidopencv31_MainActivity_fillMatrixColor(
      JNIEnv* env,
      jobject,
      jlong addrMat,
      jint red,
